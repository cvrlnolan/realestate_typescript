            ...
            <Stack>
              <Flex justifyContent="space-between">
                ...
                <Text color="gray.500" fontSize="sm" noOfLines={1} ml={2}>
                  {estate.bedrooms} Bedrooms &bull; {estate.baths} Baths &bull;{" "}
              ...
              <Text color="gray.500" noOfLines={1}>
                {estate.address}, {estate.postal_code} {estate.province}
              </Text>
              <Text color="gray.500" textAlign="right" fontSize="sm">
                {getPostedTime(estate.createDate)} day(s) ago
              </Text>
            </Stack>
          </Box>
        </chakra.a>
