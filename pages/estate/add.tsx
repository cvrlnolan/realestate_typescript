                ...
                {page === 0 && (
                  <>
                    ...
                    <FormControl>
                      ...
                      />
                      {errors.title && (
                        <AlertPop title={errors.title.message} />
                      )}
                    </FormControl>
                    <FormControl>
                      ...
                      {errors.price && (
                        <AlertPop title={errors.price.message} />
                      )}
                    </FormControl>
                    <FormControl>
                      ...
                      {errors.status && (
                        <AlertPop title={errors.status.message} />
                      )}
                    </FormControl>
                  </>
                )}
                ...
                {page === 1 && (
                  <>
                    ...
                    <FormControl>
                      ...
                      {errors.country && (
                        <AlertPop title={errors.country.message} />
                      )}
                    </FormControl>
                  </>
                )}
                ...
                {page === 2 && (
                  <>
                    ...
                    <FormControl>
                      ...
                      {errors.baths && (
                        <AlertPop title={errors.baths.message} />
                      )}
                    </FormControl>
                    <FormControl>
                    ...
                    <FormControl>
                      ...
                      <Textarea
                        ...
                        {...register("property_briefing", {
                          required:
                            "Write a little briefing about the property",
                          minLength: {
                            value: 20,
                ...
                {page === 6 && (
                  <>
                    ...
                    <FormControl>
                      ...
                      {errors.email && (
                        <AlertPop title={errors.email.message} />
                      )}
                    </FormControl>
                    <FormControl>
